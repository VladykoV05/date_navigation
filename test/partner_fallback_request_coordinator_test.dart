...
import 'package:date_navigation/features/date_navigation/presentation/controller/flows/partner_fallback_request_coordinator.dart';
import 'package:date_navigation/features/date_navigation/presentation/state/date_navigation_state.dart';
import 'package:flutter_test/flutter_test.dart';
import 'package:latlong2/latlong.dart' as latlong;

void main() {
  const coordinator = PartnerFallbackRequestCoordinator();

  test('build returns null when selected format is missing', () {
    const state = DateNavigationState(searchRadius: 777);
