...
import 'package:date_navigation/features/date_navigation/application/flows/partner_fallback_flow.dart';
import 'package:date_navigation/features/date_navigation/application/flows/partner_fallback_effects.dart';
import 'package:date_navigation/features/date_navigation/application/flows/partner_fallback_result_resolver.dart';
...
void main() {
  ...
  MeetingPoint meeting({required String placeName}) {
    return MeetingPoint(
      location: const GeoCoordinate(latitude: 53.9, longitude: 27.56),
      ...
      fullRouteGeometry: const [GeoCoordinate(latitude: 53.9, longitude: 27.56)],
    );
  }
