...
import 'room_stream_effects_coordinator.dart';
...
class RoomStreamApplicationCoordinator {
  const RoomStreamApplicationCoordinator(this._effectsCoordinator);

  final RoomStreamEffectsCoordinator _effectsCoordinator;

  RoomStreamApplicationResult build(RoomStreamUpdate update) {
    final outcome = update.outcome;
    final effects = _effectsCoordinator.buildDecision(update);
