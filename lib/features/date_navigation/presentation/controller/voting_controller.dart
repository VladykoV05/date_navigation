...
class VotingController {
  const VotingController({
    ...
    required ProposalActionsCoordinator proposalActions,
    required VoteScenarioActionsCoordinator voteScenarioActions,
    required MeetingInteractionCoordinator meetingInteraction,
